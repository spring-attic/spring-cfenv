...
public class CfService {
	 ...
	 * portion of the URI, e.g. if the uri schema is 'mysql' the field name in the JSON maybe
	 * 'mysqlUri', 'mysqluri', 'mysqlUrl' or 'mysqlurl'. This method searches for the presence
	 * of these alternatively named fields in the credentials of the service
	 * @param uriSchemes
	 * @return
	 */
